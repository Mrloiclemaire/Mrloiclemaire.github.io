...
const Header = () => {
  ...
  const toggleMenu = () => {
    menuStatus === "menu--burger closed"
      ? setMenuStatus("menu--burger opened")
      : setMenuStatus("menu--burger closed");
    burgerType === "cta--burger burger"
      ? setBurger("cta--burger cross")
  ...
  return (
    <header>
      ...
      <img
        className={burgerType}
        src={burgerType === "cta--burger burger" ? Burger : Cross}
        alt="burger-menu"
        onClick={toggleMenu}
      />
