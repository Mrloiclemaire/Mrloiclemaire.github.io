...
return (
    ...
    <div className="contact-card">
        ...
        <div className="contact-card__linkedin">
            <a href={props.linkedinurl} target="_blank" rel="noreferrer"><img className="contact-card__linkedin--logo"  alt="linkedin" src={Linkedin}/></a>
        ...
        <div className="contact-card__github">
            <a href={props.github} target="_blank" rel="noreferrer"> <img className="contact-card__github--logo" alt="github" src={Github}/></a>
